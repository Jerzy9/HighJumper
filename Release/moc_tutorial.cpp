...
#include <memory>
#include "../../High Jumper/tutorial.h"
...
QT_MOC_LITERAL(1, 9, 5), // "Close"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 21) // "on_MenuButton_clicked"

    },
    "Tutorial\0Close\0\0on_MenuButton_clicked"
};
...
void Tutorial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Tutorial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Tutorial::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tutorial::Close)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Tutorial::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Tutorial.data,
    qt_meta_data_Tutorial,
    qt_static_metacall,
    nullptr,
    nullptr
} };
