...
QT_MOC_LITERAL(1, 6, 16), // "closeSceneWindow"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Scene\0closeSceneWindow\0"
};
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeSceneWindow(); break;
        default: ;
        }
        ...
        {
            using _t = void (Scene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scene::closeSceneWindow)) {
                *result = 0;
                return;
            }
        }
